...
import type { ParsedEmbed, Widget } from "#/types/widget";
	...
	return (
		<div>
			<Textarea
				...
				rows={6}
				className="mb-3 w-full font-mono text-sm focus:outline-none focus:ring-2 focus:ring-primary"
				placeholder="Enter [[embed]] directives..."
			/>

			<div className="mb-4 flex items-center gap-2">
				<Button type="button" onClick={handleParse} className="cursor-pointer">
					Parse
				</Button>
				<Button
					type="button"
				...
				<div className="space-y-4">
					...
					{result && (
						<details className="group">
							...
							<pre className="mt-2 overflow-x-auto rounded-lg p-3 text-muted-foreground text-xs">
								{JSON.stringify(
