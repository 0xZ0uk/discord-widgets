		...
		<div tw="w-[800px] h-[400px] bg-zinc-900 rounded-3xl p-12 flex flex-col justify-between font-sans text-white relative overflow-hidden">
			...
			<div tw="flex justify-between items-start">
				<div tw="flex flex-col">
					<div tw="text-sm opacity-60 mb-1">WEATHER</div>
			...
			<div tw="flex items-end justify-between">
				<div tw="flex flex-col">
					<div tw="text-[96px] font-extrabold leading-none">{temp}</div>
					<div tw="text-2xl opacity-80 mt-2">{condition}</div>
				</div>
			</div>

			{/* Footer */}
			<div tw="text-sm opacity-40 text-right">Powered by Discord Widgets</div>
		</div>
	);
};
